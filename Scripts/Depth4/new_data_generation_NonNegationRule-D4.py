...
@author: Qiming Bao
​
Depth=4 new data generation for non negation rule
​
"""
import json
import itertools
...
for index in range(0, len(item)):
    ...
    context = [people + " " + people_relations_1[0] + " " + people_attributes_1[0] + ". " +
               ...
               "All " + people_attributes_2[4] + " people are " + people_attributes_4[2] + ". " +
               ...
               "All " + people_attributes_3[2] + " people are " + people_attributes_1[3] + ". " +
               ...
               "All " + people_attributes_3[5] + " people are " + people_attributes_1[1] + ". " +
    ...
    question0 = people + " " + people_relations_1[0] + " " + people_attributes_1[3] + "."
    label0 = "true"
    QDep0 = "4"
    question0_0 = people + " " + people_relations_1[1] + " " + people_attributes_1[3] + "."
    label0_0 = "false"
    QDep0_0 = "4"
    question1 = people_1 + " " + people_relations_1[0] + " " + people_attributes_4[2] + "."
    label1 = "true"
    QDep1 = "4"
    question1_1 = people_1 + " " + people_relations_1[1] + " " + people_attributes_4[2] + "."
    label1_1 = "false"
    QDep1_1 = "4"
    question2 = people_2 + " " + people_relations_1[0] + " " + people_attributes_1[1] + "."
    label2 = "true"
    QDep2 = "4"
    question2_2 = people_2 + " " + people_relations_1[1] + " " + people_attributes_1[1] + "."
    label2_2 = "false"
    QDep2_2 = "4"
    question3 = people_3 + " " + people_relations_1[0] + " " + people_attributes_2[1] + "."
    label3 = "true"
    QDep3 = "4"
    question3_3 = people_3 + " " + people_relations_1[1] + " " + people_attributes_2[1] + "."
    label3_3 = "false"
    QDep3_3 = "4"

    test_dict = {
        'id': "NonNegationRule-D4-" + str(id),
        'context': context[0],
        'questions': [{
            'id': "NonNegationRule-D4-" + str(id) + "1",
            'text': question0,
            'label': label0,
            'meta': {
                "QDep": QDep0,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "2",
             'text': question0_0,
             'label': label0_0,
             'meta': {
                 "QDep": QDep0_0,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "3",
             'text': question1,
             'label': label1,
             'meta': {
                 "QDep": QDep1,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "4",
             'text': question1_1,
             'label': label1_1,
             'meta': {
                 "QDep": QDep1_1,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "5",
             'text': question2,
             'label': label2,
             'meta': {
                 "QDep": QDep2,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "6",
             'text': question2_2,
             'label': label2_2,
             'meta': {
                 "QDep": QDep2_2,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "7",
             'text': question3,
             'label': label3,
             'meta': {
                 "QDep": QDep3,
            ...
            {'id': "NonNegationRule-D4-" + str(id) + "8",
             'text': question3_3,
             'label': label3_3,
             'meta': {
                 "QDep": QDep3_3,
...
with open('NonNegationRule-D4.jsonl', 'w') as f:
