...
@author: Qiming Bao
​
Depth=3 new data generation for negation rule
​
"""
...
for index in range(0, len(item)):
    ...
    context = [people + " " + people_relations_1[0] + " " + people_attributes_1[0] + ". " +
               ...
               "All " + people_attributes_4[4] + " people are " + people_attributes_2[4] + ". " +
               ...
               "All " + people_attributes_3[2] + " people are " + people_attributes_5[0] + ". "
               ]

    question0 = people + " " + people_relations_1[0] + " " + people_attributes_2[4] + "."
    label0 = "true"
    QDep0 = "3"
    question0_0 = people + " " + people_relations_1[1] + " " + people_attributes_2[4] + "."
    label0_0 = "false"
    QDep0_0 = "3"
    question1 = people_3 + " " + people_relations_1[0] + " " + people_attributes_3[5] + "."
    label1 = "true"
    QDep1 = "3"
    question1_1 = people_3 + " " + people_relations_1[1] + " " + people_attributes_3[5] + "."
    label1_1 = "false"
    QDep1_1 = "3"
    question2 = people_2 + " " + people_relations_1[0] + " " + people_attributes_5[0] + "."
    label2 = "true"
    QDep2 = "3"
    question2_2 = people_2 + " " + people_relations_1[1] + " " + people_attributes_5[0] + "."
    label2_2 = "false"
    QDep2_2 = "3"
    question3 = people_1 + " " + people_relations_1[0] + " " + people_attributes_6[0] + "."
    label3 = "true"
    QDep3 = "3"
    question3_3 = people_1 + " " + people_relations_1[1] + " " + people_attributes_6[0] + "."
    label3_3 = "false"
    QDep3_3 = "3"

    test_dict = {
        'id': "NegationRule-D3-" + str(id),
        'context': context[0],
        'questions': [{
            'id': "NegationRule-D3-" + str(id) + "1",
            'text': question0,
            'label': label0,
            'meta': {
                "QDep": QDep0,
...
with open('NegationRule-D3.jsonl', 'w') as f:
