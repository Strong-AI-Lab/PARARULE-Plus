...
@author: Qiming Bao
​
Depth=3 new data generation for negation rule animal
​
"""
...
animal_attributes_4 = ['big', 'strong', 'awful', 'fierce', 'heavy', 'horrible']
id = 0
whole_dict = []
...
for index in range(0, len(item)):
    ...
    context = [animal + " " + animal_relations[0] + " " + animal_attributes_2[0] + ". " +
               ...
               "All " + animal_attributes_3[4] + " animals are " + animal_attributes_1[1] + ". " +
    ...
    question0 = animal + " " + animal_relations[0] + " " + animal_attributes_4[5] + "."
    label0 = "true"
    QDep0 = "3"
    question0_0 = animal + " " + animal_relations[1] + " " + animal_attributes_4[5] + "."
    label0_0 = "false"
    QDep0_0 = "3"
    question1 = animal_3 + " " + animal_relations[0] + " " + animal_attributes_1[1] + "."
    label1 = "true"
    QDep1 = "3"
    question1_1 = animal_3 + " " + animal_relations[1] + " " + animal_attributes_1[1] + "."
    label1_1 = "false"
    QDep1_1 = "3"
    question2 = animal_3 + " " + animal_relations[0] + " " + animal_attributes_1[3] + "."
    label2 = "true"
    QDep2 = "3"
    question2_2 = animal_3 + " " + animal_relations[1] + " " + animal_attributes_1[3] + "."
    label2_2 = "false"
    QDep2_2 = "3"
    question3 = animal + " " + animal_relations[0] + " " + animal_attributes_4[2] + "."
    label3 = "true"
    QDep3 = "3"
    question3_3 = animal + " " + animal_relations[1] + " " + animal_attributes_4[2] + "."
    label3_3 = "false"
    QDep3_3 = "3"
    question4 = animal + " " + animal_relations[0] + " " + animal_attributes_2[3] + "."
    label4 = "true"
    QDep4 = "3"
    question4_4 = animal + " " + animal_relations[1] + " " + animal_attributes_2[3] + "."
    label4_4 = "false"
    QDep4_4 = "3"

    test_dict = {
        'id': "NegationRule-Animal-D3-" + str(id),
        'context': context[0],
        'questions': [{
            'id': "NegationRule-Animal-D3-" + str(id) + "1",
            'text': question0,
            'label': label0,
            'meta': {
                "QDep": QDep0,
                "QCat": "0_not_notTrue_true"
            }},
            {'id': "NegationRule-Animal-D3-" + str(id) + "2",
             'text': question0_0,
             'label': label0_0,
             'meta': {
                 "QDep": QDep0_0,
                 "QCat": "0_0_not_notTrue_true"
             }},
            {'id': "NegationRule-Animal-D3-" + str(id) + "3",
             'text': question1,
             'label': label1,
             'meta': {
                 "QDep": QDep1,
            ...
            {'id': "NegationRule-Animal-D3-" + str(id) + "4",
             'text': question1_1,
             'label': label1_1,
             'meta': {
                 "QDep": QDep1_1,
            ...
            {'id': "NegationRule-Animal-D3-" + str(id) + "5",
             'text': question2,
             'label': label2,
             'meta': {
                 "QDep": QDep2,
                 "QCat": "0_true_trueNot_true"
             }},
            {'id': "NegationRule-Animal-D3-" + str(id) + "6",
             'text': question2_2,
             'label': label2_2,
             'meta': {
                 "QDep": QDep2_2,
                 "QCat": "0_0_true_trueNot_true"
             }},
            {'id': "NegationRule-Animal-D3-" + str(id) + "7",
             'text': question3,
             'label': label3,
             'meta': {
                 "QDep": QDep3,
            ...
            {'id': "NegationRule-Animal-D3-" + str(id) + "8",
             'text': question3_3,
             'label': label3_3,
             'meta': {
                 "QDep": QDep3_3,
            ...
            {'id': "NegationRule-Animal-D3-" + str(id) + "9",
             'text': question4,
             'label': label4,
             'meta': {
                 "QDep": QDep4,
            ...
            {'id': "NegationRule-Animal-D3-" + str(id) + "10",
             'text': question4_4,
             'label': label4_4,
             'meta': {
                 "QDep": QDep4_4,
...
with open('NegationRule-Animal-D3.jsonl', 'w') as f:
