...
@author: Qiming Bao
​
Depth=4 new data generation for non negation rule animal
​
"""
import json
import itertools
...
animal_attributes_2 = ['dull', 'rough', 'lazy', 'slow', 'sleepy', 'tired', 'reckless']
...
for index in range(0, len(item)):
    ...
    context = [animal + " " + animal_relations[0] + " " + animal_attributes_2[0] + ". " +
               ...
               "All " + animal_attributes_2[5] + " animals are " + animal_attributes_3[1] + ". " +
               ...
               "All " + animal_attributes_3[5] + " animals are " + animal_attributes_2[1] + ". " +
               ...
               "All " + animal_attributes_4[5] + " animals are " + animal_attributes_2[0] + ". " +
               "If something is " + animal_attributes_2[4] + " then it is " + animal_attributes_3[2] + ". " +
               "All " + animal_attributes_3[2] + " animals are " + animal_attributes_2[6] + "."
               ]
    question0 = animal_2 + " " + animal_relations[0] + " " + animal_attributes_1[2] + "."
    label0 = "true"
    QDep0 = "4"
    question0_0 = animal_2 + " " + animal_relations[1] + " " + animal_attributes_1[2] + "."
    label0_0 = "false"
    QDep0_0 = "4"
    question1 = animal + " " + animal_relations[0] + " " + animal_attributes_3[1] + "."
    label1 = "true"
    QDep1 = "4"
    question1_1 = animal + " " + animal_relations[1] + " " + animal_attributes_3[1] + "."
    label1_1 = "false"
    QDep1_1 = "4"
    question2 = animal_1 + " " + animal_relations[0] + " " + animal_attributes_2[1] + "."
    label2 = "true"
    QDep2 = "4"
    question2_2 = animal_1 + " " + animal_relations[1] + " " + animal_attributes_2[1] + "."
    label2_2 = "false"
    QDep2_2 = "4"
    question3 = animal_3 + " " + animal_relations[0] + " " + animal_attributes_2[0] + "."
    label3 = "true"
    QDep3 = "4"
    question3_3 = animal_3 + " " + animal_relations[1] + " " + animal_attributes_2[0] + "."
    label3_3 = "false"
    QDep3_3 = "4"
    question4 = animal + " " + animal_relations[0] + " " + animal_attributes_2[6] + "."
    label4 = "true"
    QDep4 = "4"
    question4_4 = animal + " " + animal_relations[1] + " " + animal_attributes_2[6] + "."
    label4_4 = "false"
    QDep4_4 = "4"

    test_dict = {
        'id': "NonNegationRule-Animal-D4-" + str(id),
        'context': context[0],
        'questions': [{
            'id': "NonNegationRule-Animal-D4-" + str(id) + "1",
            'text': question0,
            'label': label0,
            'meta': {
                "QDep": QDep0,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "2",
             'text': question0_0,
             'label': label0_0,
             'meta': {
                 "QDep": QDep0_0,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "3",
             'text': question1,
             'label': label1,
             'meta': {
                 "QDep": QDep1,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "4",
             'text': question1_1,
             'label': label1_1,
             'meta': {
                 "QDep": QDep1_1,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "5",
             'text': question2,
             'label': label2,
             'meta': {
                 "QDep": QDep2,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "6",
             'text': question2_2,
             'label': label2_2,
             'meta': {
                 "QDep": QDep2_2,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "7",
             'text': question3,
             'label': label3,
             'meta': {
                 "QDep": QDep3,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "8",
             'text': question3_3,
             'label': label3_3,
             'meta': {
                 "QDep": QDep3_3,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "9",
             'text': question4,
             'label': label4,
             'meta': {
                 "QDep": QDep4,
            ...
            {'id': "NonNegationRule-Animal-D4-" + str(id) + "10",
             'text': question4_4,
             'label': label4_4,
             'meta': {
                 "QDep": QDep4_4,
...
with open('NonNegationRule-Animal-D4.jsonl', 'w') as f:
